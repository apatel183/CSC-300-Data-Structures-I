...
class MyFirstHomeworkFor300 {
	...
	public static int distanceBetweenMinAndMax(double[] list) {
		...
		double min = list[0];
		double max = list[0];
		int lowestIndex = 0; // min index
		int highestIndex = 0; //max index
		...
		return Math.abs(lowestIndex - highestIndex);	// returns the difference between min and max.
	}
	...
	public static double[] removeDuplicates(double[] list) {
		...
		return unqiueValues;	
		//double [] x = {1,2,3}; trial for running the code... 
		//return x;
		//Arpan Patel
	}
