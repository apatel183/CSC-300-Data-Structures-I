...
public class MyDeckSort {
    public static void sort (MyDeck d) {
    	...
    	for (int deckOfCardsi = 0; deckOfCardsi < size; deckOfCardsi++) //going deck of cards repate. 
    	{
    		//we can do two things for size start the at 1 in nested loop or size-1. it will be same things. 
